...
public class CSVFileParserTest {
	...
	public void successTest() throws Exception {
		List<StatementRecord> actual=csvFileParser.parseStatement(new ClassPathResource("records.csv").getFile());
	...
	public void failTest() throws Exception {
		csvFileParser.parseStatement(new ClassPathResource("invaildRecords.csv").getFile());
